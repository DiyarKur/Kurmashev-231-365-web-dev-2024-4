...
function clickHandler(event) {
    ...
    if (target.classList.contains('digits') || target.classList.contains('operation') || target.classList.contains('bracket')) {
        ...
        screen.value = result.toFixed(2); // Display result with two decimal places
    }
}
